...
import configurationTypeRoutes from "./routes/configurationTypes";
...
import equipmentVariableSettingRoutes from "./routes/equipmentVariableSettings";
...
app.use("/api/configuration-types", configurationTypeRoutes);
...
app.use("/api/equipment-variable-settings", equipmentVariableSettingRoutes);
